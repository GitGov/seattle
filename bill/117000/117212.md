...
**Text**  
    ...
    WHEREAS, PaTu Wind Farm LLC has the marketing rights to the  
    ...
    *     Attachment 2 to Confirmation Agreement --  
    ...
    1.23  "Downgrade Event" means (a) for the Seller, the  
    ...
    c.     Facility ID Number:  ___________  0 EIA or 1 QF?  
    (check one)  
