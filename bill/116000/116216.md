...
**Text**  
    ...
    * Regular Part-Time is defined as a position that has been designated  
    ...
    City Light                      Electric Util Exec 3,Dir     F                4      4  
    ...
    Dept of Executive Admin         Remittance Proc Tech         F                4      4  
    ...
    Fleets and Facilities           Delivery Wkr                 F                4      4  
    ...
    Municipal Court                 Info Technol Prgmmer Anlyst  F                2      2  
    ...
    Parks Department                Publc Ed Prgm Spec           F                3      3  
    ...
    Personnel Department            Personnel Anlyst,Sr          F                8      8  
  
    Personnel Department            Personnel Anlyst,Sr          P              0.5      1  
  
    Personnel Department            Personnel Spec,Asst          F                1      1  
  
    Personnel Department            Personnel Spec,Sr            F                1      1  
  
    Personnel Department            Plng&Dev Spec,Sr             P              0.5      1  
  
    Personnel Department            Sfty/Ocuptnl Hlth Coord      F                2      2  
  
    Personnel Department            Special Exams Anlyst         F                2      2  
  
    Personnel Department            StratAdvsr1,General Govt     F                4      4  
    ...
    Personnel Department            Workers' Comp Spec           P              0.5      1  
  
    Personnel Department            Workers' Comp Supv           F                1      1  
  
    Personnel Department Total                                                121.5    124  
    ...
    Police Department               Admin Spec I-BU              F               53     53  
  
    Police Department               Admin Spec I-BU              P              0.5      1  
  
    Police Department               Admin Spec II-BU             F               40     40  
  
    Police Department               Admin Spec III-BU            F                4      4  
  
    Police Department               Admin Staff Anlyst           F                2      2  
    ...
    Police Department               Info Technol Prof B-BU       F               12     12  
    ...
    Police Department               Parking Enf Ofcr             F               76     76  
    ...
    Police Department               Pol Lieut                    F               41     41  
    ...
    Police Department               Pol Ofcr-Detective           F              165    165  
    ...
    Police Department               Pol Ofcr-Non Patrol          F               10     10  
    ...
    Police Department               Transp Plnr,Assoc            P              0.5      1  
    ...
    Seattle Center                  Admin Spec I-BU              P              1.4      2  
  
    Seattle Center                  Admin Spec II-BU             F               10     10  
  
    Seattle Center                  Admin Spec II-BU             P              1.5      2  
  
    Seattle Center                  Admin Staff Asst             F                4      4  
    ...
    Seattle Center                  Events Svc Rep               P              1.5      3  
    ...
    Seattle Center                  Marketing Dev Coord          P             0.87      1  
    ...
    Seattle Center                  Parking Attendant            P             4.95      6  
    ...
    Seattle Center Total                                                      278.3    296  
  
    Seattle Dept of Transportation  Accountant                   F                4      4  
  
    Seattle Dept of Transportation  Accountant,Prin              F                2      2  
  
    Seattle Dept of Transportation  Accountant,Sr                F                2      2  
  
    Seattle Dept of Transportation  Actg Tech I-BU               F                1      1  
  
    Seattle Dept of Transportation  Actg Tech II-BU              F                8      8  
  
    Seattle Dept of Transportation  Actg Tech II-BU              P              0.5      1  
  
    Seattle Dept of Transportation  Actg Tech III-BU             F                3      3  
  
    Seattle Dept of Transportation  Actg Tech Supv-BU            F                1      1  
  
    Seattle Dept of Transportation  Admin Spec I-BU              F                9      9  
  
    Seattle Dept of Transportation  Admin Spec I-BU              P              0.5      1  
  
    Seattle Dept of Transportation  Admin Spec II                F                1      1  
  
    Seattle Dept of Transportation  Admin Spec II-BU             F                9      9  
  
    Seattle Dept of Transportation  Admin Spec II-BU             P              0.5      1  
  
    Seattle Dept of Transportation  Admin Spec III-BU            F                8      8  
  
    Seattle Dept of Transportation  Admin Staff Anlyst           F                4      4  
  
    Seattle Dept of Transportation  Manager2,Engrng&Plans Rev    F               10     10  
  
    Seattle Dept of Transportation  Manager2,Fin,Bud,&Actg       F                2      2  
  
    Seattle Dept of Transportation  Manager2,General Govt        F                5      5  
  
    Seattle Dept of Transportation  Manager3,Engrng&Plans Rev    F                8      8  
    ...
    Seattle Dept of Transportation  Manager3,P&FM                F                1      1  
  
    Seattle Dept of Transportation  Mat Controller               F                1      1  
  
    Seattle Dept of Transportation  Mgmt Systs Anlyst            F                1      1  
  
    Seattle Dept of Transportation  Mgmt Systs Anlyst,Sr         F                5      5  
    ...
    Seattle Dept of Transportation  Personnel Spec               F                4      4  
  
    Seattle Dept of Transportation  Personnel Spec               P              0.5      1  
  
    Seattle Dept of Transportation  Personnel Spec,Sr            F                3      3  
  
    Seattle Dept of Transportation  Plng&Dev Spec II             F                2      2  
  
    Seattle Dept of Transportation  Plng&Dev Spec,Sr             F                1      1  
    ...
    Seattle Dept of Transportation  Publc Relations Spec,Sr      F                2      2  
  
    Seattle Dept of Transportation  Publc Relations Supv         F                1      1  
  
    Seattle Dept of Transportation  Radio Comms Spec             F                1      1  
  
    Seattle Dept of Transportation  Radio Dispatcher             F                8      8  
  
    Seattle Dept of Transportation  Real Property Agent,Sr       F                4      4  
  
    Seattle Dept of Transportation  Res&Eval Asst-BU             F                1      1  
  
    Seattle Dept of Transportation  Sfty&Hlth Spec               F                1      1  
  
    Seattle Dept of Transportation  Sfty&Hlth Spec,Sr            F                2      2  
    ...
    Seattle Dept of Transportation  Signal Elctn V               F               31     31  
  
    Seattle Dept of Transportation  Stat Maint Mach              F                1      1  
  
    Seattle Dept of Transportation  StratAdvsr1,CSPI&P           F                2      2  
  
    Seattle Dept of Transportation  StratAdvsr1,Exempt           F                1      1  
  
    Seattle Dept of Transportation  StratAdvsr1,Fin,Bud,&Actg    F                2      2  
  
    Seattle Dept of Transportation  StratAdvsr1,General Govt     F                9      9  
  
    Seattle Dept of Transportation  StratAdvsr2,Engrng&Plans     F               10     10  
                                    Rev  
  
    Seattle Dept of Transportation  StratAdvsr2,Exempt           F                3      3  
  
    Seattle Dept of Transportation  StratAdvsr2,Exempt           P              0.5      1  
  
    Seattle Dept of Transportation  StratAdvsr2,General Govt     F               16     16  
  
    Seattle Dept of Transportation  StratAdvsr2,General Govt     P              0.5      1  
    ...
    Seattle Dept of Transportation  Traffic Marking Lead Wkr     F                7      7  
  
    Seattle Dept of Transportation  Traffic Sign&Marking CC I    F                1      1  
  
    Seattle Dept of Transportation  Traffic Sign&Marking CC II   F                1      1  
  
    Seattle Dept of Transportation  Transp Plnr,Assoc            F               12     12  
  
    Seattle Dept of Transportation  Transp Plnr,Assoc            P              1.5      3  
  
    Seattle Dept of Transportation  Transp Plnr,Asst             F                2      2  
  
    Seattle Dept of Transportation  Transp Plnr,Sr               F               16     16  
  
    Seattle Dept of Transportation  Transp Plnr,Sr               P                1      2  
  
    Seattle Dept of Transportation  Tree Trimmer                 F                4      4  
  
    Seattle Dept of Transportation  Tree Trimmer,Lead            F                2      2  
  
    Seattle Dept of Transportation  Truck Drvr                   F               38     38  
    ...
    Seattle Dept of Transportation                                              778    785  
    Total  
    ...
    Seattle Public Utilities        Actg Tech III-BU             P             1.75      3  
    ...
    Seattle Public Utilities        Admin Spec II-BU             P              1.5      3  
    ...
    Seattle Public Utilities        Admin Staff Anlyst           P              0.5      1  
    ...
    Seattle Public Utilities        Apprentice                   F                7      7  
  
    Seattle Public Utilities        Apprenticeship Coord         F                1      1  
  
    Seattle Public Utilities        Auto Engr                    F                1      1  
  
    Seattle Public Utilities        Capital Prjts Coord          F                5      5  
    ...
    Seattle Public Utilities        Civil Engr,Assoc             F               37     37  
    ...
    Seattle Public Utilities        Civil Engr,Sr                F               54     54  
  
    Seattle Public Utilities        Civil Engrng Spec Supv       F                8      8  
  
    Seattle Public Utilities        Civil Engrng Spec,Assoc      F               31     31  
  
    Seattle Public Utilities        Civil Engrng Spec,Asst I     F               14     14  
  
    Seattle Public Utilities        Civil Engrng Spec,Asst II    F                2      2  
  
    Seattle Public Utilities        Civil Engrng Spec,Asst III   F               15     15  
  
    Seattle Public Utilities        Civil Engrng Spec,Sr         F               33     33  
    ...
    Seattle Public Utilities        Cust Svc Rep                 P              0.5      1  
    ...
    Seattle Public Utilities        Drainage&Wstwtr Coll CC      F                7      7  
  
    Seattle Public Utilities        Drainage&Wstwtr Coll Lead    F               37     37  
                                    Wkr  
    ...
    Seattle Public Utilities        Envrnmtl Anlyst,Assoc        F                9      9  
    ...
    Seattle Public Utilities        Envrnmtl Fld Spec            F                5      5  
    ...
    Seattle Public Utilities        Executive1                   F                4      4  
  
    Seattle Public Utilities        Executive2                   F               25     25  
    ...
    Seattle Public Utilities        Info Technol Prof A,Exempt   F               20     20  
  
    Seattle Public Utilities        Info Technol Prof B-BU       F               40     40  
  
    Seattle Public Utilities        Info Technol Prof C-BU       F               40     40  
    ...
    Seattle Public Utilities        Manager3,Engrng&Plans Rev    F               16     16  
    ...
    Seattle Public Utilities        Personnel Spec               F                2      2  
    ...
    Seattle Public Utilities        Plng&Dev Spec I              P              0.5      1  
  
    Seattle Public Utilities        Plng&Dev Spec II             F               15     15  
  
    Seattle Public Utilities        Plng&Dev Spec II             P              0.5      1  
  
    Seattle Public Utilities        Plng&Dev Spec,Sr             F               17     17  
  
    Seattle Public Utilities        Plng&Dev Spec,Sr             P              0.5      1  
  
    Seattle Public Utilities        Plng&Dev Spec,Supvsng        F                2      2  
    ...
    Seattle Public Utilities        Solid Wst Fld Rep,Lead       F                4      4  
    ...
    Seattle Public Utilities        StratAdvsr1,General Govt     F                5      5  
  
    Seattle Public Utilities        StratAdvsr1,PC&RM            F                1      1  
  
    Seattle Public Utilities        StratAdvsr1,Utils            F                9      9  
    ...
    Seattle Public Utilities        StratAdvsr2,Utils            F               19     19  
    ...
    Seattle Public Utilities        Util Act Rep I               F               70     70  
  
    Seattle Public Utilities        Util Act Rep I               P             2.75      5  
    ...
    Seattle Public Utilities        Util Svc Inspector           F                7      7  
    ...
    Seattle Public Utilities        Wtrworks Maint Hlpr-SMU      F                2      2  
    ...
    Seattle Public Utilities        Wtrworks Maint Spec-SMU      F                2      2  
  
    Seattle Public Utilities        Wtrworks Maint Supv          F                2      2  
  
    Seattle Public Utilities Total                                          1470.06   1485  
  
    Grand Total                                                            10861.26  11108  
