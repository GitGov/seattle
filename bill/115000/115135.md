...
**Text**  
    ...
    Whereas, Yakima County and the Cities above named have entered into an  
    ...
    b.  Yakima County will annually reconcile each City's unused beds (the  
    ...
    E. Each quarter Yakima County shall send to the Cities an accounting  
    ...
    Note: as part of the annual reconciliation, reduced rate beds  
    initially allocated to cities that only need part or none of their  
    share will be reallocated to the remaining cities.  
  
    Attachment C  
  
    2003 Reconciliation and Payment of Unused Beds and Method for Annual  
    Allocation and Reconciliation of Unused Beds  
