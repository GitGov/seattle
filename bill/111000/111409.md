...
**Text**  
    ...
    Consider it appropriate for Seattle to designate small areas that  
    ...
    2. If the purpose fo the environment is to provide public access,  
    ...
    a. Equitable access to all service providers that seek to use the  
