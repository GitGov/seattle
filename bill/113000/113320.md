...
**Text**  
    ...
    WHEREAS, while it is possible to individually redevelop these  
    ...
    ***  
    ...
    e. Departures from development standards may be granted  
    ...
    4. Development standard departure for structure height may  
